...
В рамках второго этапа была сформирована ER-модель базы данных, представляющая собой концептуальную схему системы управления кондиционерами. Модель включает все основные сущности предметной области и связи между ними.
